...
ax[2].plot(positions[:, 18], label = "end_eff_x_traj")
ax[2].plot(positions[:, 19], label = "end_eff_y_traj")
ax[2].plot(positions[:, 20], label = "end_eff_z_traj")
ax[2].set_xlabel("millisec")
ax[2].set_ylabel("m")
ax[2].legend()
ax[2].grid()

ax[3].plot(velocities[:, 18], label = "end_eff_x_vel")
ax[3].plot(velocities[:, 19], label = "end_eff_y_vel")
ax[3].plot(velocities[:, 20], label = "end_eff_z_vel")
