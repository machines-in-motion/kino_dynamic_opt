...
//       * @param[in]  ref_sequence                         dynamics sequence to be used as momentum tracking reference
//       * @param[in]  is_not_first_kindyn_iteration        signals if it is the first kinematics-dynamics iteration
//       */
//      void optimize(const DynamicsState& ini_state, const DynamicsSequence& ref_sequence, bool is_not_first_kindyn_iteration = false);
//
//      /**
...
//       */
//      DynamicsSequence& kinematicsSequence() { return dyn_sequence_; }
//      const DynamicsSequence& kinematicsSequence() const { return dyn_sequence_; }
//
//      /**
...
//       */
//      void optimizePosture(DynamicsState& current_state, const DynamicsState& desired_state, bool is_not_initial_state = true, bool include_torque_limits = false);
//
...
//       */
//      DynamicsState ini_state_, current_state_;
//
//      /**
